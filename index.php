...
<body>
    ...
    <footer>
        <div class="container">
            <div class="footer-content dflex-between">
                ...
                <div class="left">
                    ...
                    <ul class="footer-list">
                        <li class="footer-list-item"><a href="#">Google</a></li>
                        <li class="footer-list-item"><a href="#">Tutto su Google</a></li>
                        <li class="footer-list-item"><a href="#">Privacy</a></li>
                        <li class="footer-list-item"><a href="#">Termini</a></li>
                    </ul>
                </div>
